		...
		post(addon_info and (addon_info.important and development) or channel,
			{
				...
				embed = {
					...
					["author"] = {
						...
						["icon_url"] = avatar and tostring(avatar) or (addon_info and addon_info.icon or "https://identicons.github.com/" .. (addon_name == "=[C]" and (stack[max_level].name or "internal") or addon_name) .. ".png")
					},
					["footer"] = {
